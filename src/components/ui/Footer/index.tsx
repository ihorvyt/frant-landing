    ...
    const svgWebDevelopmentIcon = (
        <svg xmlns="http://www.w3.org/2000/svg" width="49" height="49" viewBox="0 0 49 49" fill="none">
            <path
                ...
                stroke="white" stroke-width="2.68478"/>
            <path
    ...
    const svgWebDesignIcon = (
        <svg width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke="white" stroke-width="2.5248"/>
            <path
            ...
            <path
                ...
                stroke="white" stroke-width="2.5248" stroke-linecap="round"/>
            ...
            <path
                ...
                fill="white" stroke="white" stroke-width="2.5248"/>
            <path
